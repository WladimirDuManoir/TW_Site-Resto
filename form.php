...
include_once('model/updateIncidentScrImage.php');
...
$user_id = false;
// incident id generated by mysql database
$incident_id = false;
$user_error = "";
...
if( isset($_POST['sname'] )
	...
	if($form_sent) {
		...
		$filename = uploads("incident-".$user_id."-".$incident_id, $user_error);
		// update filename
		updateIncidentScrImage($incident_id, $filename);
	}
	$no_anim = true;
	$form_completed = true;
	...
	<div class="row">
		<div class="col-sm-3">
		  <div class="form-group <?php echo ($no_anim ? '' : 'wow') ?> fadeInLeft" data-wow-delay="0.1s">
			...
			<label>
			<input aria-describedby="descriptionUrgence" name="severity" type="radio"  value="1"> Peu urgent<br>
			<input aria-describedby="descriptionUrgence" name="severity" type="radio"  value="2" checked> Urgent<br>
			<input aria-describedby="descriptionUrgence" name="severity" type="radio"  value="3"> Très urgent</label><br>
		...
		<div class="col-sm-3">
		  <div class="form-group <?php echo ($no_anim ? '' : 'wow') ?> fadeInRight" data-wow-delay="0.1s">
			...
			<label>
			<input aria-describedby="descriptionSuivi" name="follow" type="radio" name="group2" value="0"> Web<br>
			<input aria-describedby="descriptionSuivi" name="follow" type="radio" name="group2" value="1"> Mail<br>
			<input aria-describedby="descriptionSuivi" name="follow" type="radio" name="group2" value="2" checked> Téléphone</label><br>
